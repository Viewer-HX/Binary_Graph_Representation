...
if __name__ == '__main__':
    ...
    log_file_name = "patched-security-num-attr-info.log"
    idx = 0
    ...
    sub_graph_format_dir = "/home/binaryf/Binary_database/Crawler/slicedcfg/itera_3/" \
    ...
    numerical_attribute_dir = "/home/binaryf/Binary_database/Crawler/slicedcfg/itera_3/" \
    ...
    for num in range(1, security_split_num):
        ...
        main(commits_dir)
    print("Total block detailed number: {} in security patches.".format(block_num))
